    ...
    "translations": {
      "he": {
        "consentModal": {
          ...
          "description": "התקנת מקלחונים בהתאמה אישית משתמש בעוגיות כדי לשפר את החוויה שלך, לנתח שימוש באתר ולסייע במאמצי השיווק שלנו.",
    ...
    contactForm.addEventListener('submit', async function(e) {
        ...
        try {
            ...
            const response = await fetch('https://api.zappy5.com/api/email/contact-form', {
                ...
                body: JSON.stringify({
                    websiteId: 'b92e9c93-f420-4c89-a0a8-bdb0d2ea237d',
                    name: data.name || '',
                    email: data.email || '',
